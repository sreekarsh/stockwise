...
const envSchema = z.object({
  // In some CI/health-check environments `.env` is not present.
  // Zod defaults should normally handle missing values, but we also make
  // behavior explicit by marking them optional and defaulting in schema.
  SESSION_SECRET: z
    .string()
